...
const (
	AlgoType_AT_INVALID  AlgoType = 0
	AlgoType_DYNAMIC_SRS AlgoType = 1
	AlgoType_LINEAR_SRS  AlgoType = 2
	AlgoType_STATIC_SRS  AlgoType = 3
	AlgoType_TEST_SRS    AlgoType = 4
)
...
func (AlgoType) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_proto_common_proto_enumTypes[3].Descriptor()
}

func (AlgoType) Type() protoreflect.EnumType {
	return &file_pkg_proto_common_proto_enumTypes[3]
}
...
type Deck struct {
	...
	Algorithm       AlgoType  `protobuf:"varint,10,opt,name=algorithm,proto3,enum=common.AlgoType" json:"algorithm,omitempty"`
}
...
func (x *Deck) GetAlgorithm() AlgoType {
	if x != nil {
		return x.Algorithm
	}
	return AlgoType_AT_INVALID
}
...
type UserDueResponse struct {
	...
	NewCards int64 `protobuf:"varint,2,opt,name=newCards,proto3" json:"newCards,omitempty"`
	DueDecks int64 `protobuf:"varint,3,opt,name=dueDecks,proto3" json:"dueDecks,omitempty"`
}

func (x *UserDueResponse) Reset() {
	*x = UserDueResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_proto_common_proto_msgTypes[21]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UserDueResponse) Descriptor() ([]byte, []int) {
	return file_pkg_proto_common_proto_rawDescGZIP(), []int{21}
}
...
func (x *UserDueResponse) GetNewCards() int64 {
	if x != nil {
		return x.NewCards
	}
	return 0
...
func (x *SrsPushRequest) Reset() {
	*x = SrsPushRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_proto_common_proto_msgTypes[22]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SrsPushRequest) Descriptor() ([]byte, []int) {
	return file_pkg_proto_common_proto_rawDescGZIP(), []int{22}
}
...
func (x *BindingRequest) Reset() {
	*x = BindingRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_proto_common_proto_msgTypes[23]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BindingRequest) Descriptor() ([]byte, []int) {
	return file_pkg_proto_common_proto_rawDescGZIP(), []int{23}
}
...
var file_pkg_proto_common_proto_rawDesc = []byte{
	...
	0x43, 0x61, 0x72, 0x64, 0x53, 0x69, 0x64, 0x65, 0x49, 0x44, 0x22, 0xe5, 0x02, 0x0a, 0x04, 0x44,
	...
	0x74, 0x65, 0x12, 0x2e, 0x0a, 0x09, 0x61, 0x6c, 0x67, 0x6f, 0x72, 0x69, 0x74, 0x68, 0x6d, 0x18,
	0x0a, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x10, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x41,
	0x6c, 0x67, 0x6f, 0x54, 0x79, 0x70, 0x65, 0x52, 0x09, 0x61, 0x6c, 0x67, 0x6f, 0x72, 0x69, 0x74,
	0x68, 0x6d, 0x22, 0x47, 0x0a, 0x0b, 0x44, 0x65, 0x63, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	,
	...
	,
	...
	,
...
var file_pkg_proto_common_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_pkg_proto_common_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_pkg_proto_common_proto_goTypes = []interface{}{
	...
	(AlgoType)(0),                           // 3: common.AlgoType
	(*Success)(nil),                         // 4: common.Success
	(*User)(nil),                            // 5: common.User
	(*Users)(nil),                           // 6: common.Users
	(*Group)(nil),                           // 7: common.Group
	(*Groups)(nil),                          // 8: common.Groups
	(*GroupRequest)(nil),                    // 9: common.GroupRequest
	(*GroupMembers)(nil),                    // 10: common.GroupMembers
	(*ManageGroupMemberRequestRequest)(nil), // 11: common.ManageGroupMemberRequestRequest
	(*GroupModUserRequest)(nil),             // 12: common.GroupModUserRequest
	(*GroupInviteRequest)(nil),              // 13: common.GroupInviteRequest
	(*Card)(nil),                            // 14: common.Card
	(*CardRequest)(nil),                     // 15: common.CardRequest
	(*Cards)(nil),                           // 16: common.Cards
	(*CardSide)(nil),                        // 17: common.CardSide
	(*CardSideRequest)(nil),                 // 18: common.CardSideRequest
	(*Deck)(nil),                            // 19: common.Deck
	(*DeckRequest)(nil),                     // 20: common.DeckRequest
	(*Decks)(nil),                           // 21: common.Decks
	(*PushSubscriptionRequest)(nil),         // 22: common.PushSubscriptionRequest
	(*PushSubscription)(nil),                // 23: common.PushSubscription
	(*PushSubscriptions)(nil),               // 24: common.PushSubscriptions
	(*UserDueResponse)(nil),                 // 25: common.UserDueResponse
	(*SrsPushRequest)(nil),                  // 26: common.SrsPushRequest
	(*BindingRequest)(nil),                  // 27: common.BindingRequest
}
var file_pkg_proto_common_proto_depIdxs = []int32{
	1,  // 0: common.User.groupRole:type_name -> common.GroupRole
	5,  // 1: common.Users.users:type_name -> common.User
	0,  // 2: common.Group.groupType:type_name -> common.GroupType
	1,  // 3: common.Group.role:type_name -> common.GroupRole
	7,  // 4: common.Groups.groups:type_name -> common.Group
	7,  // 5: common.GroupRequest.group:type_name -> common.Group
	5,  // 6: common.GroupMembers.users:type_name -> common.User
	7,  // 7: common.GroupModUserRequest.group:type_name -> common.Group
	7,  // 8: common.GroupInviteRequest.group:type_name -> common.Group
	17, // 9: common.Card.sides:type_name -> common.CardSide
	14, // 10: common.CardRequest.card:type_name -> common.Card
	14, // 11: common.Cards.cards:type_name -> common.Card
	17, // 12: common.CardSideRequest.cardSide:type_name -> common.CardSide
	1,  // 13: common.Deck.deckRole:type_name -> common.GroupRole
	2,  // 14: common.Deck.deckType:type_name -> common.DeckType
	3,  // 15: common.Deck.algorithm:type_name -> common.AlgoType
	19, // 16: common.DeckRequest.deck:type_name -> common.Deck
	19, // 17: common.Decks.decks:type_name -> common.Deck
	23, // 18: common.PushSubscriptionRequest.subscription:type_name -> common.PushSubscription
	23, // 19: common.PushSubscriptions.subscriptions:type_name -> common.PushSubscription
...
func file_pkg_proto_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pkg_proto_common_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_proto_common_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_proto_common_proto_msgTypes[23].Exporter = func(v interface{}, i int) interface{} {
