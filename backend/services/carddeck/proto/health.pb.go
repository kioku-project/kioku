...
type HealthCheckResponse struct {
	...
	Status HealthCheckResponse_ServingStatus `protobuf:"varint,1,opt,name=status,proto3,enum=cardDeck.HealthCheckResponse_ServingStatus" json:"status,omitempty"`
}
...
var file_proto_health_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x08, 0x63, 0x61, 0x72, 0x64, 0x44, 0x65, 0x63, 0x6b, 0x22, 0x2e,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2b, 0x2e, 0x63, 0x61, 0x72, 0x64, 0x44, 0x65, 0x63,
	...
	,
...
var file_proto_health_proto_goTypes = []interface{}{
	(HealthCheckResponse_ServingStatus)(0), // 0: cardDeck.HealthCheckResponse.ServingStatus
	(*HealthCheckRequest)(nil),             // 1: cardDeck.HealthCheckRequest
	(*HealthCheckResponse)(nil),            // 2: cardDeck.HealthCheckResponse
}
var file_proto_health_proto_depIdxs = []int32{
	0, // 0: cardDeck.HealthCheckResponse.status:type_name -> cardDeck.HealthCheckResponse.ServingStatus
	1, // 1: cardDeck.Health.Check:input_type -> cardDeck.HealthCheckRequest
	1, // 2: cardDeck.Health.Watch:input_type -> cardDeck.HealthCheckRequest
	2, // 3: cardDeck.Health.Check:output_type -> cardDeck.HealthCheckResponse
	2, // 4: cardDeck.Health.Watch:output_type -> cardDeck.HealthCheckResponse
