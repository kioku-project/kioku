...
import (
	...
	"github.com/kioku-project/kioku/services/linearSrs/handler"
	pb "github.com/kioku-project/kioku/services/linearSrs/proto"
...
func main() {
	...
	// Register handler
	if err := pb.RegisterLinearSrsHandler(srv.Server(), svc); err != nil {
		logger.Fatal(err)
	}
