...
type HealthCheckResponse struct {
	...
	Status HealthCheckResponse_ServingStatus `protobuf:"varint,1,opt,name=status,proto3,enum=login.HealthCheckResponse_ServingStatus" json:"status,omitempty"`
}
...
var file_proto_health_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x22, 0x2e, 0x0a, 0x12, 0x48,
	...
	0x28, 0x09, 0x52, 0x07, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x22, 0xa8, 0x01, 0x0a, 0x13,
	...
	0x01, 0x28, 0x0e, 0x32, 0x28, 0x2e, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x2e, 0x48, 0x65, 0x61, 0x6c,
	...
	,
}
...
var file_proto_health_proto_goTypes = []interface{}{
	(HealthCheckResponse_ServingStatus)(0), // 0: login.HealthCheckResponse.ServingStatus
	(*HealthCheckRequest)(nil),             // 1: login.HealthCheckRequest
	(*HealthCheckResponse)(nil),            // 2: login.HealthCheckResponse
}
var file_proto_health_proto_depIdxs = []int32{
	0, // 0: login.HealthCheckResponse.status:type_name -> login.HealthCheckResponse.ServingStatus
	1, // 1: login.Health.Check:input_type -> login.HealthCheckRequest
	1, // 2: login.Health.Watch:input_type -> login.HealthCheckRequest
	2, // 3: login.Health.Check:output_type -> login.HealthCheckResponse
	2, // 4: login.Health.Watch:output_type -> login.HealthCheckResponse
