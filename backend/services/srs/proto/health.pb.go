...
type HealthCheckResponse struct {
	...
	Status HealthCheckResponse_ServingStatus `protobuf:"varint,1,opt,name=status,proto3,enum=srs.HealthCheckResponse_ServingStatus" json:"status,omitempty"`
}
...
var file_proto_health_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x03, 0x73, 0x72, 0x73, 0x22, 0x2e, 0x0a, 0x12, 0x48, 0x65, 0x61,
	...
	0x52, 0x07, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x22, 0xa6, 0x01, 0x0a, 0x13, 0x48, 0x65,
	...
	0x0e, 0x32, 0x26, 0x2e, 0x73, 0x72, 0x73, 0x2e, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43, 0x68,
	...
	,
...
var file_proto_health_proto_goTypes = []interface{}{
	(HealthCheckResponse_ServingStatus)(0), // 0: srs.HealthCheckResponse.ServingStatus
	(*HealthCheckRequest)(nil),             // 1: srs.HealthCheckRequest
	(*HealthCheckResponse)(nil),            // 2: srs.HealthCheckResponse
}
var file_proto_health_proto_depIdxs = []int32{
	0, // 0: srs.HealthCheckResponse.status:type_name -> srs.HealthCheckResponse.ServingStatus
	1, // 1: srs.Health.Check:input_type -> srs.HealthCheckRequest
	1, // 2: srs.Health.Watch:input_type -> srs.HealthCheckRequest
	2, // 3: srs.Health.Check:output_type -> srs.HealthCheckResponse
	2, // 4: srs.Health.Watch:output_type -> srs.HealthCheckResponse
