...
import (
	...
	"github.com/kioku-project/kioku/services/staticSrs/handler"
	pb "github.com/kioku-project/kioku/services/staticSrs/proto"
...
func main() {
	...
	// Register handler
	if err := pb.RegisterStaticSrsHandler(srv.Server(), svc); err != nil {
		logger.Fatal(err)
	}
